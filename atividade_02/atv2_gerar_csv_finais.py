...
# Modelos utilizados na Atividade 1
...
try:
    ...
    for modelo in modelos:
        ...
        # id
        # Se já tiver uma coluna de ID. Se não cria números de 1 até o fim.
        ...
        # must_have_score
        # Tenta procurar alguma nota que já tenha (Juiz, BERTScore, ou TokenF1).
        if f'Nota_Juiz_{modelo}' in df_m1.columns:
            ...
            # Deixa vazio para não quebrar a formatação 
